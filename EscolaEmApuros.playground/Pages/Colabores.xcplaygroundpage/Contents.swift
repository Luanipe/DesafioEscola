...
//}
//
// let marcos = Colaborador(nome: "Marcos", matricula: 419, salario: 3569.00, cargo: .assistente)
/*:
 Excelente!
...
let maria = Colaborador(nome: "Maria", matricula: 861, salario: 7500.00, cargo: .diretor)
maria.seApresentar()
/*:
